...
function rr(r){if(r.type==='header')return'<div class="sysinfo-header">'+r.l+'</div>';if(r.isLoad)return'<div class="sysinfo-row"><span class="lbl">'+r.l+'</span><div class="load-row"><span class="load-badge '+lc(r.v1)+'">1m '+(r.v1!==undefined?r.v1:'--')+'</span><span class="load-badge '+lc(r.v5)+'">5m '+(r.v5!==undefined?r.v5:'--')+'</span><span class="load-badge '+lc(r.v15)+'">15m '+(r.v15!==undefined?r.v15:'--')+'</span></div></div>';return'<div class="sysinfo-row"><span class="lbl">'+r.l+'</span><span class="val">'+r.v+'</span></div>'}

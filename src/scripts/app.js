...
function baseOpt(lbs){return{grid:{left:0,right:0,top:4,bottom:0},xAxis:{type:'category',data:lbs,show:false},yAxis:{type:'value',show:false,min:0},animationDuration:300}}
...
ec('chart-cpu');window._echarts['chart-cpu'].setOption(Object.assign(baseOpt(lbs),{yAxis:{type:'value',show:false,min:0,max:cpuMax},series:[{type:'line',data:cpuPts.map(function(p){return p.r}),smooth:true,symbol:'none',lineStyle:{width:2,color:'#10b981'},areaStyle:{color:grad('rgba(16,185,129,0.12)')}}],tooltip:{trigger:'axis'}}))
ec('chart-mem');window._echarts['chart-mem'].setOption(Object.assign(baseOpt(lbs),{yAxis:{type:'value',show:false,min:0,max:memMax},series:[{type:'line',data:memPts.map(function(p){return p.r}),smooth:true,symbol:'none',lineStyle:{width:2,color:'#818cf8'},areaStyle:{color:grad('rgba(129,140,248,0.12)')}}],tooltip:{trigger:'axis'}}))

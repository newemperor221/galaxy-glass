module.exports = {
  ...
  "shadowStrength": "1%",
  "shadowStrength3": "calc(var(--shadow-strength) + 2%)",
  "shadowStrength4": "calc(var(--shadow-strength) + 3%)",
  "shadowStrength5": "calc(var(--shadow-strength) + 4%)",
  "shadowStrength6": "calc(var(--shadow-strength) + 5%)",
  "shadowStrength7": "calc(var(--shadow-strength) + 6%)",
  "shadowStrength8": "calc(var(--shadow-strength) + 7%)",
  "shadowStrength10": "calc(var(--shadow-strength) + 9%)",
  ...
  "shadow1": "0 1px 2px -1px hsl(var(--shadow-color) / var(--shadow-strength-10))",
  "shadow2": "\n    0 3px 5px -2px hsl(var(--shadow-color) / var(--shadow-strength-4)),\n    0 7px 14px -5px hsl(var(--shadow-color) / var(--shadow-strength-6))",
  "shadow3": "\n    0 -1px 3px 0 hsl(var(--shadow-color) / var(--shadow-strength-3)),\n    0 1px 2px -5px hsl(var(--shadow-color) / var(--shadow-strength-3)),\n    0 2px 5px -5px hsl(var(--shadow-color) / var(--shadow-strength-5)),\n    0 4px 12px -5px hsl(var(--shadow-color) / var(--shadow-strength-6)),\n    0 12px 15px -5px hsl(var(--shadow-color) / var(--shadow-strength-8))",
  "shadow4": "\n    0 -2px 5px 0 hsl(var(--shadow-color) / var(--shadow-strength-3)),\n    0 1px 1px -2px hsl(var(--shadow-color) / var(--shadow-strength-4)),\n    0 2px 2px -2px hsl(var(--shadow-color) / var(--shadow-strength-4)),\n    0 5px 5px -2px hsl(var(--shadow-color) / var(--shadow-strength-5)),\n    0 9px 9px -2px hsl(var(--shadow-color) / var(--shadow-strength-6)),\n    0 16px 16px -2px hsl(var(--shadow-color) / var(--shadow-strength-7))",
  "shadow5": "\n    0 -1px 2px 0 hsl(var(--shadow-color) / var(--shadow-strength-3)),\n    0 2px 1px -2px hsl(var(--shadow-color) / var(--shadow-strength-4)),\n    0 5px 5px -2px hsl(var(--shadow-color) / var(--shadow-strength-4)),\n    0 10px 10px -2px hsl(var(--shadow-color) / var(--shadow-strength-5)),\n    0 20px 20px -2px hsl(var(--shadow-color) / var(--shadow-strength-6)),\n    0 40px 40px -2px hsl(var(--shadow-color) / var(--shadow-strength-8))",
  "shadow6": "\n    0 -1px 2px 0 hsl(var(--shadow-color) / var(--shadow-strength-3)),\n    0 3px 2px -2px hsl(var(--shadow-color) / var(--shadow-strength-4)),\n    0 7px 5px -2px hsl(var(--shadow-color) / var(--shadow-strength-4)),\n    0 12px 10px -2px hsl(var(--shadow-color) / var(--shadow-strength-5)),\n    0 22px 18px -2px hsl(var(--shadow-color) / var(--shadow-strength-6)),\n    0 41px 33px -2px hsl(var(--shadow-color) / var(--shadow-strength-7)),\n    0 100px 80px -2px hsl(var(--shadow-color) / var(--shadow-strength-8))",
  "innerShadow0": "inset 0 0 0 1px hsl(var(--shadow-color) / var(--shadow-strength-10))",
  "innerShadow1": "inset 0 1px 2px 0 hsl(var(--shadow-color) / var(--shadow-strength-10)), var(--inner-shadow-highlight)",
  "innerShadow2": "inset 0 1px 4px 0 hsl(var(--shadow-color) / var(--shadow-strength-10)), var(--inner-shadow-highlight)",
  "innerShadow3": "inset 0 2px 8px 0 hsl(var(--shadow-color) / var(--shadow-strength-10)), var(--inner-shadow-highlight)",
  "innerShadow4": "inset 0 2px 14px 0 hsl(var(--shadow-color) / var(--shadow-strength-10)), var(--inner-shadow-highlight)",
  "layer1": 1,
  "layer2": 2,
  "layer3": 3,
  "layer4": 4,
  ...
  "paletteHue": "250",
  "paletteHueRotateBy": "0",
  "paletteChroma": "0.15",
  "color1": "oklch(98% calc(0.03 * var(--palette-chroma)) calc(var(--palette-hue) + (0 * var(--palette-hue-rotate-by))))",
  "color2": "oklch(97% calc(0.06 * var(--palette-chroma)) calc(var(--palette-hue) + (1 * var(--palette-hue-rotate-by))))",
  "color3": "oklch(93% calc(0.1 * var(--palette-chroma)) calc(var(--palette-hue) + (2 * var(--palette-hue-rotate-by))))",
  "color4": "oklch(84% calc(0.12 * var(--palette-chroma)) calc(var(--palette-hue) + (3 * var(--palette-hue-rotate-by))))",
  "color5": "oklch(80% calc(0.16 * var(--palette-chroma)) calc(var(--palette-hue) + (4 * var(--palette-hue-rotate-by))))",
  "color6": "oklch(71% calc(0.19 * var(--palette-chroma)) calc(var(--palette-hue) + (5 * var(--palette-hue-rotate-by))))",
  "color7": "oklch(66% calc(0.2 * var(--palette-chroma)) calc(var(--palette-hue) + (6 * var(--palette-hue-rotate-by))))",
  "color8": "oklch(58% calc(0.21 * var(--palette-chroma)) calc(var(--palette-hue) + (7 * var(--palette-hue-rotate-by))))",
  "color9": "oklch(53% calc(0.2 * var(--palette-chroma)) calc(var(--palette-hue) + (8 * var(--palette-hue-rotate-by))))",
  "color10": "oklch(49% calc(0.19 * var(--palette-chroma)) calc(var(--palette-hue) + (9 * var(--palette-hue-rotate-by))))",
  "color11": "oklch(42% calc(0.17 * var(--palette-chroma)) calc(var(--palette-hue) + (10 * var(--palette-hue-rotate-by))))",
  "color12": "oklch(35% calc(0.15 * var(--palette-chroma)) calc(var(--palette-hue) + (11 * var(--palette-hue-rotate-by))))",
  "color13": "oklch(27% calc(0.12 * var(--palette-chroma)) calc(var(--palette-hue) + (12 * var(--palette-hue-rotate-by))))",
  "color14": "oklch(20% calc(0.09 * var(--palette-chroma)) calc(var(--palette-hue) + (13 * var(--palette-hue-rotate-by))))",
  "color15": "oklch(16% calc(0.07 * var(--palette-chroma)) calc(var(--palette-hue) + (14 * var(--palette-hue-rotate-by))))",
  "color16": "oklch(10% calc(0.05 * var(--palette-chroma)) calc(var(--palette-hue) + (15 * var(--palette-hue-rotate-by))))"
}